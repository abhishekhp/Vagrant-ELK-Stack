This vagrant box installs elasticsearch 1.7, logstash 1.5.4 and kibana 4.1.1 on Ubuntu trusty 32 ( 32 bit because
)
...
##Kibana  - may need to install manually a 32 bit version of kibana
